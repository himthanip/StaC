...
print("F1 MACRO : ", f1_score(Y_Test_All, Y_Pred_DFrame_L2, average = 'macro'))
print("F1 MICRO : ", f1_score(Y_Test_All, Y_Pred_DFrame_L2, average = 'micro'))
print("F1 SAMPLES : ", f1_score(Y_Test_All, Y_Pred_DFrame_L2, average = 'samples'))
